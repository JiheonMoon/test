...
public class Ex02_ReadImage {
	public static void main(String[] args) {
		...
		try {
			System.out.println("기존 스트림으로 읽기 시작");
			readFile = new FileInputStream("D:\\web0900_mjh\\1.java/wall.jpg");
			...
			bisReadFile = new FileInputStream("D:\\web0900_mjh\\1.java/wall.jpg");
